...
public class BookDirectoryTestSuite {
    ...
    void testListBooksWithConditionsReturnList() {
        ...
        // Given
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);// tworzymy obiekt klasy bookLibratry
        // ale dlaczego w nawiasach jest Mock z interfejsu ?
    ...
    void testListBooksInHandsOf() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Jan", "Kowalski", "789654");
    ...
    void testListBooksInHandsOfWithOneBook() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser = new LibraryUser("Jan", "Kowalski", "2234234");
